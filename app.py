...
st.set_page_config(page_title="RAM Library", page_icon="📚", initial_sidebar_state="expanded",
                   menu_items={
...
if st.sidebar.checkbox('Login As A member'):
    ...
    if authentication_status:
        ...
        <span style="float:left;font-size: 25px; color: #8387d0;line-height: 16pt;">WELCOME DEAR STUDENT</span>
        """,
                              width=400, height=50)
        ...
        selector = st.sidebar.selectbox('Chose your mode (Default : All Books) ', ['All Books',
...
elif st.sidebar.checkbox('Continue without registering'):
